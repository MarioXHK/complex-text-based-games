...
class enemy:
    def __init__(self,type,fren = False,hurt = "none",xpos = 100,ypos = 100,xsize = 20,ysize = 20):
        ...
        if random.randrange(0, 2) == 1:
            self.left = True
    def deprint(self):
        print([self.type, self.fren, self.hurt, self.live, self.xpos, self.ypos, self.xsize, self.ysize, self.left, self.grounded, self.vx, self.vy])
